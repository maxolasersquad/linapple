...
auto main(int argc, char *argv[]) -> int {
  ...
  while ((opt = getopt_long(argc, argv, "1:2:abc:fhlmpr:s:vx:T:X:6CA:", OptionTable, &optind)) != -1) {
    switch (opt) {
      ...
      case 'X': uTestTrap = static_cast<uint16_t>(strtol(optarg, nullptr, 0)); break;
